...
\begin{figure*}[t!]
        ...
        \caption{On the left, the TLC run performed 2 minutes after the addition of the reagents to the flask. The spots from left to right are corresponding to benzaldehyde, pyrrole and the reaction solution. At the center the TLC run 5 minutes after the addition of the reagents, with On the right, the TLC run performed 30 minutes after the addition of the reagents to the flask. The spots from left to right are corresponding to benzaldehyde, pyrrole, commercial H$_{2}$-TPP and the reaction solution.}
        \label{tlc-h2tpp}
\end{figure*}
\section{Conclusions}
